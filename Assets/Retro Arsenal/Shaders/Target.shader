	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 rotatedValue72 = RotateAroundAxis( float3( 0,0,0 ), (input.positionOS.xyz*0.0 + ( sin( ( _TimeParameters.x * _BobSpeed ) ) * appendResult276 ).xyz), float3(0,1,0), ( _TimeParameters.x * _RotationSpeed ) );
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord101 = input.ase_texcoord9.xy * temp_cast_0 + float2( 0,0 );
				float2 panner95 = ( _TimeParameters.x * float2( 0,1.5 ) + texCoord101);
				float2 temp_cast_1 = (2.0).xx;
				float2 texCoord186 = input.ase_texcoord9.xy * temp_cast_1 + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 tex2DNode9 = tex2D( _Background, uv_Background );
				float2 temp_cast_0 = (1.0).xx;
				float2 texCoord101 = input.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 panner95 = ( _TimeParameters.x * float2( 0,1.5 ) + texCoord101);
				float2 temp_cast_1 = (2.0).xx;
				float2 texCoord186 = input.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 panner184 = ( _TimeParameters.x * float2( 0,2 ) + texCoord186);
				float4 panColor278 = _PanColor;
				float4 pan2280 = ( tex2D( _PanningTexture, panner184 ) * 0.5 * panColor278 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;344;452.916,111.1001;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=346D1DFB181D89FF5648CA10F29D8630239A5532